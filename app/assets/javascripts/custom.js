...
if(!$("#logo-menu").hasClass("ah")){    
    if ($cookieMenuSytle != null) {
        ...
        if($cookieMenuSytle=="fixed") { $("#logo-menu").removeClass("ah");   }else{ $("#logo-menu").addClass("ah");if($("#logo>img").attr("src")=="/assets/logo.png"){ $("#logo>img").attr("src","/assets/logo2.png"); $("#logo").css("height",50);  } };
...
if($("#logo-menu").hasClass("ah")){
    ...
    $('#logo-menu').hover(function (q) {
     ...
     $(".footer_controls .arrow").css({'top':-25, 'right':'45px', 'background':'url(/assets/footer_arrow_up.png) 0 0 no-repeat' });
     $("body.light .footer_controls .arrow").css({'top':-25, 'right':'45px', 'background':'url(/assets/footer_arrow-light_up.png) 0 0 no-repeat' });
    ...
    $("input[name=pageStyleVariant]").click(function () {
        if ($(this).attr("value") == "light") {
            ...
            Cufon.replace(".footer_controls>li>div h3,.footer_controls>li>div b", {
             ...
             $(".footer_controls .arrow").css({'top':-25, 'right':'45px', 'background':'url(/assets/footer_arrow-light_up.png) 0 0 no-repeat' });
